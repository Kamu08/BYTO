				...
				<div className='flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center'>
					...
					<div className='w-1/2  px-4'>
						...
						<nav className='list-none mb-10'>
							...
							<li>
								<a className='text-gray-400 hover:text-white'>Insurance FAQ</a>
							</li>
							<li>
								<a className='text-gray-400 hover:text-white'>Zero tolerance policy</a>
							</li>
						</nav>
					</div>
					<div className='w-1/2  px-4'>
						...
						<nav className='list-none mb-10'>
							<li>
								<a className='text-gray-400 hover:text-white'>Blogs & Articles</a>
							</li>
							<li>
								<a className='text-gray-400 hover:text-white'>Address of Company</a>
							</li>
							<li>
							...
							<li>
								<a className='text-gray-400 hover:text-white'>Driver partner terms & conditions</a>
							</li>
						</nav>
					</div>
				</div>
